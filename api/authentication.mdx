...
description: Learn how to authenticate with the OrgStack API using JWT bearer tokens
---

## Overview

The OrgStack API uses JSON Web Tokens (JWT) for authentication. To access protected endpoints, you must include a valid JWT token in the `Authorization` header of your requests.
