---
title: API reference
description: Planned REST API for OrgStack multi-tenant organization management
---
...
<Info>
  All API requests will require authentication using JWT bearer tokens. Learn more in the [Authentication](/api/authentication) specification.
</Info>
