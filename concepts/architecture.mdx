---
title: Architecture
description: Learn about OrgStack's clean layered architecture and separation of concerns
---

## Overview

OrgStack follows a **clean layered architecture** that separates concerns and makes the codebase maintainable, testable, and scalable. The architecture enforces clear boundaries between layers, with each layer having specific responsibilities.
